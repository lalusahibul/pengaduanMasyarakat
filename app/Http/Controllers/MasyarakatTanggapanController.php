...
class MasyarakatTanggapanController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('masyarakat.tanggapan.tanggapan', ['tanggapan' => $tanggapan, 'pengaduan' => $peng, 'petugas' => $pet]);
    }
    ...
    public function create()
    {
        ...
        return view('masyarakat.tanggapan.tambah', ['masyarakat' => $masyarakat, 'petugas' => $petugas, 'pengaduan' => $pengaduan]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('masyarakat_tanggapan');
    }
    ...
    public function edit($tanggapan)
    {
        ...
        $pengaduan = Pengaduan::latest()->get();
        $petugas = Petugas::latest()->get();
        return view('masyarakat.tanggapan.edit', ['tanggapan' => $tang, 'masyarakat' => $masyarakat, 'pengaduan' => $pengaduan, 'petugas' => $petugas]);
    }
