...
class PetugasPengaduanController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('petugas.pengaduan.pengaduan', ['pengaduan' => $pengaduan]);
    }
    ...
    public function create()
    {
        ...
        return view('petugas.pengaduan.tambah', ['masyarakat' => $masyarakat]);
    }
    ...
    public function edit($pengaduan)
    {
        ...
        $masyarakat = Masyarakat::latest()->get();
        return view('petugas.pengaduan.edit', ['pengaduan' => $peng, 'masyarakat' => $masyarakat]);
    }
    ...
    public function petugaspengaduan_konfirmasi($pengaduan, $aksi)
    {
        $peng = Pengaduan::where('id_pengaduan', $pengaduan)->first();
        $data['status'] = $aksi;
        Pengaduan::where('id_pengaduan', $peng->id_pengaduan)->update($data);
