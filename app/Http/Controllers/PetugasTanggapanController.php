...
class PetugasTanggapanController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('petugas.tanggapan.tanggapan', ['tanggapan' => $tanggapan, 'pengaduan' => $peng, 'petugas' => $pet]);
    }
    ...
    public function create()
    {
        ...
        return view('petugas.tanggapan.tambah', ['masyarakat' => $masyarakat, 'petugas' => $petugas, 'pengaduan' => $pengaduan]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('petugas_tanggapan');
    }
    ...
    public function edit($tanggapan)
    {
        ...
        $pengaduan = Pengaduan::latest()->get();
        $petugas = Petugas::latest()->get();
        return view('petugas.tanggapan.edit', ['tanggapan' => $tang, 'masyarakat' => $masyarakat, 'pengaduan' => $pengaduan, 'petugas' => $petugas]);
    }
