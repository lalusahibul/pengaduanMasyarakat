    ...
    <div class="col-12">
        <div class="bg-light rounded h-100 p-4">
            ...
            <div class="table-responsive">
                <a href="/admin_tanggapan/create" class="btn btn-success m-2">Tambah Tanggapan</a>
                <table class="table">
                    <thead>
                        <tr>
                            <th scope="col">No</th>
                    ...
                    <tbody>
                        @foreach ($tanggapan as $index => $row)
                            <tr>
                                ...
                                <td>
                                    <form action="/admin_tanggapan/{{ $row->id_tanggapan }}" method="post">
                                        @csrf
                                        @method('delete')
                                        <a href="/admin_tanggapan/{{ $row->id_tanggapan }}/edit"
